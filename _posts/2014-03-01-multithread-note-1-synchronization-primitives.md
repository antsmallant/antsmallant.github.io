...
等有空还是要亲自看一下 pthread 的源码，看看 `pthread_cond_wait`，`pthread_cond_signal` 的具体实现。或许可以先看下这篇文章：[《深入了解glibc的条件变量》](https://blog.csdn.net/qq_31442743/article/details/131548997)      
