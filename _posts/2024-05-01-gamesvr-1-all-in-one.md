...
全区全服游戏，战斗的时候是开房间式的，匹配够 n 个人就开始一盘游戏，即相当于 n 个人在同一个房间内游戏。     
...
|服务器|作用|
|:--|:--|
|sdksvr|1、为玩家提供登录、注册、充值、版本更新、停服公告等功能；2、为外部厂商提供充值回调、推广回调等功能|
|plazasvr|1、为玩家提供游戏接入点；2、提供除了战斗之外的所有功能；|
|battlesvr|1、为玩家提供战斗功能|
|matchsvr|1、为玩家提供战斗匹配；2、对 battlesvr 进行调度&负载均衡|
|managesvr|1、为运营人员提供后台管理功能；2、为运营人员提供统计数据查看功能|
