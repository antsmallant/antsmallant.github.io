...
实际上，拆解下来，技术团队的核心追求就是：10x生产力，也就是 Elon Musk 在 Tesla，SpaceX 团队达到的状态。  
...
![halo : optimization-is-dangerous](https://antsmallant-blog-1251470010.cos.ap-guangzhou.myqcloud.com/media/blog/game-networking-halo-optimize-optimization-is-dangerous.png)  
...
![halo-optimize-inspection-tools-are-the-key](https://antsmallant-blog-1251470010.cos.ap-guangzhou.myqcloud.com/media/blog/game-networking-halo-optimize-inspection-tools-are-the-key.png)  
...
聊到这个，就不得不提起我曾经对一款 MMOARPG 做数据库优化的经历了。boss 也是做服务端出身的，他在开会的时候特别会挑战。入职后我第一次参会的时候就见识到他的威力了，同事被喷得特别惨，因为他们做的东西没有数据支撑，基本上是靠猜测的。    

而我做优化就显得很有章法：   

* 优化前，做了大量的 log 埋点，进行数据收集、数据分析，精准的定位出数据库性能问题，并且还对优化项分了优先级，逐步实施。 
* 优化时，一步步的实施优化，每次上线后都有相应的 log 来验证优化结果。 
* 优化后，对优化结果进行量化，确认优化到位。   

所以，轮到我做汇报的时候，boss 对我的工作赞不绝口。   
...
大部分情况下，我们是可以通过面试的沟通中觉察出对方的不对劲的，但招人总会失误的，或者说人总会变的。并且刺头也可能是个关系户，这个在小公司比较常见。  
